...
public class OrderServiceTest {
    ...
    public void testGetOrderByID_OrderNotFound() {
        ...
        GearUpException exception = assertThrows(GearUpException.class, () -> orderService.getOrderByID(1));
    ...
    public void testGetAllOrders_NoOrders() {
        ...
        GearUpException exception = assertThrows(GearUpException.class, () -> orderService.getAllOrders());
        assertEquals(HttpStatus.NOT_FOUND, exception.getStatus());
