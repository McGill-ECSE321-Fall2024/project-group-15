...
public class CustomerServiceTest {
    ...
    public void testGetAllCustomers_EmptyList() {
        ...
        GearUpException e = assertThrows(GearUpException.class, () -> customerService.findAllCustomers());
    ...
    public void testCreateCustomer_EmailTaken() {
        ...
        GearUpException e = assertThrows(GearUpException.class, () -> customerService.createCustomer(name, password, email, address, phoneNumber));
    ...
    public void testDeleteCustomerNotFound() {
        ...
        GearUpException e = assertThrows(GearUpException.class, () -> customerService.deleteCustomer(customer));
