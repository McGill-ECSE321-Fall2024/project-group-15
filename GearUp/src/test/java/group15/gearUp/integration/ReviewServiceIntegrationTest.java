...
import group15.gearUp.dto.OrderDto;
import group15.gearUp.dto.ReviewDto;
...
public class ReviewServiceIntegrationTest {
    ...
    @BeforeEach
    public void setUp() {
        // Initialize and save a equipment
        equipment = new Equipment();
        equipment.setTitle("Test equipment");
        equipmentRepository.save(equipment);
        validEquipmentId = equipment.getEquipmentID();
        ...
        review.setDescription("Great equipment!");
        ...
        updatedReview.setEquipment(equipment);
        ...
        // updatedReviewDto.setDescription("Good equipment!");
        // updatedReviewDto.setEquipmentId(validEquipmentId);
    ...
    public void testUpdateReviewSuccess() {
        ...
        savedReview.setEquipment(equipment);
    ...
    public void testGetReviewByIdSuccess() {
        ...
        savedReview.setDescription("Excellent equipment!");
        savedReview.setEquipment(equipment);
        savedReview.setCustomer(customer);
        int reviewId = savedReview.getReviewID();
    ...
    // Test to retrieve reviews by equipment
    @Test
    @Order(4)
    public void testGetReviewsByequipmentSuccess() {
        // Create a review for the equipment
        Review review = new Review();
        review.setRating(Rating.THREE_STAR);
        review.setDescription("Average equipment");
        review.setEquipment(equipment);
        review.setCustomer(customer);

        // Act
        ResponseEntity<List<ReviewDto>> response = client.getForEntity(
                "/review/equipment/" + validEquipmentId,
                null,
    ...
    public void testDeleteReviewUnauthorized() {
        ...
        savedReview.setDescription("Good equipment");
        savedReview.setEquipment(equipment);
        savedReview.setCustomer(customer);
        int reviewId = savedReview.getReviewID();
