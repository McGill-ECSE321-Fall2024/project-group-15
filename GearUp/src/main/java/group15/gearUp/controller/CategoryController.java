...
import group15.gearUp.dto.CategoryDto;
import group15.gearUp.model.Category;
import group15.gearUp.service.CategoryService;
...
public class CategoryController{
   ...
   @PostMapping("/category/assign/{EquipmentId}")
   public ResponseEntity<String> assignEquipmentToCategory(@PathVariable("EquipmentId") int EquipmentId, @RequestBody CategoryDto categoryDto) {
        categoryService.assignEquipmentToCategory(EquipmentId, categoryDto.getCategoryID());
        return new ResponseEntity<>("Equipment successfully assigned to category.", HttpStatus.OK);
    }
