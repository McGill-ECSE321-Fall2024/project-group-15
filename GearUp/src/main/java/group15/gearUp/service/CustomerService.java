...
public class CustomerService {
    ...
    public Customer getCustomerByID(int customerID) {
        ...
        if (customer == null) {
            throw new GearUpException(HttpStatus.BAD_GATEWAY, String.format("There is no customer with ID %d", customerID));
        }
        return customer;
    }
    ...
    public Customer getCustomerByEmail(String email) {
        ...
        if (customer == null) {
            throw new GearUpException(HttpStatus.BAD_GATEWAY, String.format("There is no customer with email %s", email));
        }
        return customer;
    }
     ...
     * @throws GearUpException if there are no customers in the system
     */
    public List<Customer> findAllCustomers() {
        List<Customer> customers = customerRepository.findAll();
        if (customers.isEmpty()) {
            throw new GearUpException(HttpStatus.BAD_GATEWAY, "There are no customers in the system");
        }
        return customers;
    }
    ...
    public Customer createCustomer(String username, String password, String email, String address, String phoneNumber) {
        ...
        if (customerRepository.findByEmail(email) != null) {
            throw new GearUpException(HttpStatus.CONFLICT, "Email is already taken.");
        }
        if (address == null || address.trim().isEmpty()) {
            throw new GearUpException(HttpStatus.BAD_REQUEST, "Address is required.");
        }
        if (phoneNumber == null || !phoneNumber.matches("^\\+?[0-9]{10,15}$")) {
            throw new GearUpException(HttpStatus.BAD_REQUEST, "Invalid phone number format.");
        }
     ...
     * @throws GearUpException if the customer to delete does not exist
     * @return void
     */
    @Transactional
    public void deleteCustomer(Customer customerToDelete) {
        if (customerRepository.findByUserID(customerToDelete.getUserID()) == null) {
            throw new GearUpException(HttpStatus.BAD_REQUEST, "The customer to delete does not exist");
        }
     ...
     * @throws GearUpException if the customer or new username is invalid
     */
    public Customer updateCustomerUsername(Customer customer, String newUsername) {
        if (customer == null) {
            throw new GearUpException(HttpStatus.BAD_GATEWAY, "Customer not found.");
        }
     ...
     * @return the updated Customer object
     * @throws GearUpException if the customer or new password is invalid
     */
     ...
     * @return the updated Customer object
     * @throws GearUpException if the customer or new email is invalid
     */
     ...
     * @return the updated Customer object
     * @throws GearUpException if the customer or new address is invalid
     */
     ...
     * @return the updated Customer object
     * @throws GearUpException if the customer or new phone number is invalid
     */
