...
public class EmployeeService {
    ...
    public Employee updateEmployee(int employeeId, Employee updatedEmployee) {
        ...
        if (existingEmployee == null) {
            throw new GearUpException(HttpStatus.NOT_FOUND, "Employee with the specified ID does not exist.");
        }
     ...
     * @throws GearUpException if the employee with the given ID is not found
     */
    @Transactional
    public Employee getEmployeeById(int id) {
        Employee employee = employeeRepo.findByUserID(id);
        if (employee == null) {
            throw new GearUpException(HttpStatus.NOT_FOUND, "Employee not found.");
        }
        return employee;
    }
     ...
     * @throws GearUpException if the employee with the given email is not found
     */
    @Transactional
     ...
     * @throws GearUpException if no employee records are found
     */
    @Transactional
    public List<Employee> getAllEmployees() {
        List<Employee> employees = employeeRepo.findAll();
        if (employees.isEmpty()) {
            throw new GearUpException(HttpStatus.NO_CONTENT, "No employee records found in the system.");
        }
        return employees;
    }
