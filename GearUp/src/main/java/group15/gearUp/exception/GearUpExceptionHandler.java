...
@ControllerAdvice
public class GearUpExceptionHandler {
    @ExceptionHandler(GearUpException.class)
    public ResponseEntity<ErrorDto> handleEventRegistrationException(GearUpException e) {
